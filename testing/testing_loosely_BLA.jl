using Plots, OpenFASTsr, DelimitedFiles, Rotors, DynamicStallModels, CCBlade
...
aftypes[1] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/Cylinder1.dat") #readdlm("./OpenFAST_NREL5MW/Airfoils/Cylinder1.dat", skipstart=54) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/Cylinder1.dat", radians=false)
aftypes[2] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/Cylinder2.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/Cylinder2.dat", skipstart=55) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/Cylinder2.dat", radians=false)
aftypes[3] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/DU21_A17.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/DU21_A17.dat", skipstart=54) # AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/DU40_A17.dat", radians=false)
aftypes[4] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/DU25_A17.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/DU25_A17.dat", skipstart=54) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/DU35_A17.dat", radians=false)
aftypes[5] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/DU30_A17.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/DU30_A17.dat", skipstart=54) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/DU30_A17.dat", radians=false)
aftypes[6] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/DU35_A17.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/DU35_A17.dat", skipstart=54) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/DU25_A17.dat", radians=false)
aftypes[7] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/DU40_A17.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/DU40_A17.dat", skipstart=54) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/DU21_A17.dat", radians=false)
aftypes[8] = of.read_airfoilinput("./OpenFAST_NREL5MW/Airfoils/NACA64_A17.dat") # readdlm("./OpenFAST_NREL5MW/Airfoils/NACA64_A17.dat", skipstart=54) #AlphaAF("/Users/adamcardoza/.julia/dev/CCBlade/data/NACA64_A17.dat", radians=false)
...
# plot!(tvec_of[1:2], phiof[1:2], lab="OpenFAST")
# display(phiplt)
