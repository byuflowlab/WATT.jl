...
#=
Todo:  I need to check that the motion of the deflections matches up with increases and decreases in the velocities that the blade sees. 

Todo: I need to compare the deflections of Rotors.jl to OpenFAST
...
function createydeflectionanimation()
    ...
    gif(anim, "bodydeflections_looselycoupled_081022.gif", fps = framespersecond)
end
