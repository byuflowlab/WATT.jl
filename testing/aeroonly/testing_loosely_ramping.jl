...
Try a ramping input. Downside is OpenFAST doesn't have a way to run just AeroDyn with a ramping input. so.... this comparison is pretty meaningless. 

Adam Cardoza 8/10/22
=# 
...
ramptime = 1.0
env = rampingU(rho, mu, a, vinf, omega, ramptime)
