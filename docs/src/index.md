...
- GXBeam uses blank elements instead of Legendre-spectral finite elements (sic).
- All of the code, and packages used are in julia, allowing for the implementation of automatic derivatives (AD). 
